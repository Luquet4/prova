...
def media_vendas(dic, minimo):
  try:
    media = {nomes: sum(dic[nomes]) / len(dic[nomes]) for nomes in dic}
    print(isinstance(minimo, (str, int)))
    resultado = {nomes: media[nomes] for nomes in media if media[nomes] >= minimo}
    print(resultado)
  except Exception as e:
    print(e)

media_vendas(vendas, 150)